...
//   Trash
// } from 'lucide-react';
// import { mockUniversities, mockCourses, mockStudents, getUniversities } from '../../data/mockData';
// import { useAuth } from '../../contexts/AuthContext';
// import { useEffect } from 'react';
// import { getUsersByUniversityAndRole } from '../../data/mockData';
// import { Universities, UserDTO } from '../../types';
...
//       value: mockStudents.reduce((sum, student) => sum + student.enrolledCourses.length, 0),
//       icon: GraduationCap,
//       color: 'bg-orange-500',
//       trend: '+23%'
//     }
...
//     e.preventDefault();
//     const success = await addUniversity(universityForm);
//     if (success) {
...
//                   <p className="text-sm text-gray-600">1000 students</p>
//                 </div>
...
//                     <div>
//                       <div className="text-sm font-medium text-gray-900">{uni.universityName}</div>
//                       <div className="text-sm text-gray-500">Est. {uni.establishedYear}</div>
//                     </div>
//                   </td>
//                   <td className="px-6 py-4 text-sm text-gray-900">{uni.fullName}</td>
...
//                   onChange={(e) => setUniversityForm({...universityForm, establishedYear: parseInt(e.target.value)})}
//                   className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                     <input
//                       type="number"
//                       defaultValue={editingItem.establishedYear}
//                       className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
//                     />
//                   </div>
...
import { mockStudents, getUniversities, getCourseById, getEnrollments, getStudentCountByUniversity } from '../../data/mockData';
import { useAuth } from '../../contexts/AuthContext';
import { useEffect } from 'react';
import { getUsersByUniversityAndRole } from '../../data/mockData';
...
useEffect(() => {
  if (universityId) {
    getStudentCountByUniversity(universityId).then(setStudentCount).catch(console.error);
  }
}, [universityId]);
